...
#define _LANGUAGE_PT_H_
    ...
    #define PT_LANGUAGE             "Português"
    #define PT_HEAT                 "Aquecer"
    #define PT_MOVE                 "Mover"
    #define PT_HOME                 "Início"
    #define PT_PRINT                "Imprimir"
    #define PT_EXTRUDE              "Extrudir"
    #define PT_FAN                  "Ventoinha"
    #define PT_SETTINGS             "Config" // "Configurar"
    #define PT_SCREPT_SETTINGS      "Ecrã"
    ...
    #define PT_PAGE_UP              "Subir página"
    #define PT_PAGE_DOWN            "Página abaixo"
    ...
    #define PT_DISCONNECT           "Disconnect" // "Desconectar"
    ...
    #define PT_ADJUST_TITLE         "Calibração do Touch Screen"
    ...
    #define PT_TFTSD_INSERTED       "Cartão inserido!"
    #define PT_TFTSD_REMOVED        "Cartão removido!" 
    ...
    #define PT_IS_PAUSE             "Não é possível a extrusão durante a impressão, pausar a impressão?"
    ...
    #define PT_EMERGENCYSTOP        "PARAR"
    #define PT_TOUCH_TO_EXIT        "Toque em qualquer lugar para sair"
<<<<<<< Updated upstream
=======
    #define PT_MAINMENU             "Menu"
    #define PT_WAIT_TEMP_SHUT_DOWN  "Aguarde a temperatura do hotend ser inferior a "STRINGIFY(AUTO_SHUT_DOWN_MAXTEMP)"℃" // Wait for the temperature of hotend to be lower than 50℃
