...
#define _LANGUAGE_FR_H_
    ...
    #define FR_SCREEN_SETTINGS      "Screen"
    #define FR_MACHINE_SETTINGS     "Machine"
    #define FR_FEATURE_SETTINGS     "Feature"
    #define FR_SILENT_ON            "Silent On"
    #define FR_SILENT_OFF           "Silent Off"
    #define FR_SHUT_DOWN            "Shut Down"
    #define FR_RGB_SETTINGS         "LED Color"
    #define FR_RGB_RED              "Red"
    #define FR_RGB_GREEN            "Green"
    #define FR_RGB_BLUE             "Blue"
    #define FR_RGB_WHITE            "White"
    ...
    #define FR_BLTOUCH_DEPLOY       "Deploy"
    ...
    #define FR_TOUCHSCREEN_ADJUST   "Ajust TS"
    ...
    #define FR_GRAY                 "gris"
    #define FR_DISCONNECT           "Déco"
    #define FR_BAUDRATE_115200      "115200"
    #define FR_BAUDRATE_250000      "250000"
    #define FR_RUNOUT_OFF           "Détect OFF"
    #define FR_RUNOUT_ON            "Détect ON"
    #define FR_SMART_RUNOUT_ON      "Smart ON"
    #define FR_PERCENTAGE           "Avances %"
    ...
    #define FR_ADJUST_FAILED        "Ajustement non OK, essayez encore"
    ...
    #define FR_TFTSD_INSERTED       "Carte inserée!"
    ...
    #define FR_READ_ONBOARDSD_ERROR "Erreur de Lecture carte SD interne!"
    ...
    #define FR_IS_PAUSE             "Unable to extrude when printing, Pause printing?"
    #define FR_AUTO_SHUT_DOWN       "Auto Power"
    #define FR_MANUAL_SHUT_DOWN     "Manual"
    #define FR_UNIFIEDMOVE          "Movement"
