...
const char *const tuga_pack[LABEL_NUM]={
  TUGA_LANGUAGE,
  TUGA_HEAT,
  TUGA_MOVE,
  TUGA_HOME,
  ...
  TUGA_FAN,
  TUGA_SETTINGS,
  TUGA_SCREPT_SETTINGS,
  TUGA_MACHINE_SETTINGS,
  TUGA_FEATURE_SETTINGS,
  TUGA_SILENT_ON,
  TUGA_SILENT_OFF,
  TUGA_SHUT_DOWN,
  TUGA_RGB_SETTINGS,
  ...
  TUGA_GRAY,
  TUGA_DISCONNECT,
  TUGA_BAUDRATE_115200,
  TUGA_BAUDRATE_250000,
  TUGA_RUNOUT_OFF,
  TUGA_RUNOUT_ON,
  TUGA_SMART_RUNOUT_ON,
  TUGA_PERCENTAGE,
  TUGA_BABYSTEP,
  TUGA_PERCENTAGE_SPEED,
  TUGA_PERCENTAGE_FLOW,
  TUGA_VALUE_ZERO,
  TUGA_1_DEGREE,
  TUGA_5_DEGREE,
  TUGA_10_DEGREE,
  ...
  TUGA_CONFIRM,
  TUGA_TFTSD,
  TUGA_READ_TFTSD_ERROR,
  TUGA_TFTSD_INSERTED,
  TUGA_TFTSD_REMOVED,
  TUGA_U_DISK,
  TUGA_READ_U_DISK_ERROR,
  TUGA_U_DISK_INSERTED,
  TUGA_U_DISK_REMOVED,
  TUGA_ONBOARDSD,
  TUGA_READ_ONBOARDSD_ERROR,
  TUGA_FILAMENT_RUNOUT,
  TUGA_PREHEAT,
  TUGA_PREHEAT_BOTH,
  TUGA_PREHEAT_PLA,
  TUGA_PREHEAT_PETG,
  TUGA_PREHEAT_ABS,
  TUGA_PREHEAT_CUSTOM1,
  TUGA_PREHEAT_CUSTOM2,
  TUGA_IS_PAUSE,
  TUGA_AUTO_SHUT_DOWN,
  TUGA_MANUAL_SHUT_DOWN,
  TUGA_UNIFIEDMOVE,
  TUGA_UNIFIEDHEAT,
  TUGA_COOLDOWN,
  TUGA_EMERGENCYSTOP,
...
u8 * textSelect(u8 sel)
{
  switch(infoSettings.language)
  {
    ...
    case TUGA:        return (u8 *)tuga_pack[sel];
